	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($order_id) {
        		$this->session->set_flashdata('success', 'Créé avec succès');
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($update == true) {
        		$this->session->set_flashdata('success', 'Modifié avec succès');
			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>N° Facture:</b> '.$order_data['bill_no'].'<br>
			        <b>Nom Client:</b> '.$order_data['customer_name'].'<br>
			        <b>Addresse:</b> '.$order_data['customer_address'].' <br />
			        <b>Telephone:</b> '.$order_data['customer_phone'].'
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
